  ...
  console.log("Path params : ", pathParams);
    switch (httpMethod) {
      case "GET":
        ...
        .then( function(conn) {
          connection = conn;
            const person_id = 'eu-west-1:b1ac2b48-1948-4487-89fc-c766a422d417';
            //const person_id = cognitoIdentityId;
            var query = connection.query("SELECT * FROM tinpon LEFT JOIN tinpon_swiped ON tinpon.id = tinpon_swiped.tinpon_id WHERE tinpon_swiped.person_id = '"+person_id+"' AND tinpon_swiped.liked = '3';");
          return query;
        })
        .then( function(rows) {
          connection.end()
